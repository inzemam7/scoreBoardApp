...
//     setGoalHistory((prev) => [...prev, { team: 'A', time: timer }]);
//   };

//   const handleGoalB = () => {
//     setTeamBScore((prev) => prev + 1);
//     setGoalHistory((prev) => [...prev, { team: 'B', time: timer }]);
//   };
...
//       // Only end if one team has an insurmountable lead
//       if (teamADiff > (5 - penaltyRound) || teamBDiff > (5 - penaltyRound)) {
...
//       if (penaltyTeamAScore > penaltyTeamBScore) return `${parsedMatch.teamA.teamName} Wins on Penalties!`;
//       if (penaltyTeamBScore > penaltyTeamAScore) return `${parsedMatch.teamB.teamName} Wins on Penalties!`;
//       return 'Penalty Shootout in Progress';
//     }
...
//           {isPenaltyShootout && (
//             <Text style={styles.penaltyScore}>Penalties: {penaltyTeamAScore}</Text>
//           )}
//         </View>
...
//           {isPenaltyShootout && (
//             <Text style={styles.penaltyScore}>Penalties: {penaltyTeamBScore}</Text>
//           )}
//         </View>
//       </View>
...
//         {isPenaltyShootout && (
//           <>
//             <Text style={styles.penaltyRound}>Penalty Round: {penaltyRound}</Text>
